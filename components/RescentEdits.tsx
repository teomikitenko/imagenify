...
const RescentEdits = ( {page,count,search}:{count:number,page:string,search:string}) => {
  return (
    <div className="flex flex-col gap-9">
      <div className="flex justify-between">
        <h1 className="text-4xl font-extrabold text-blue-950 dark:text-slate-200">Rescent Edits</h1>
